...
public class VueMetro extends JFrame implements ActionListener
{
	...
	public VueMetro()
	{
		...
		this.setTitle("Gestion des métros d'Alstom");
				...
				this.uneTable.addMouseListener(new MouseListener() {
					...
					public void mouseClicked(MouseEvent e) {
						if (e.getClickCount() >=2)
							...
							int retour = JOptionPane.showConfirmDialog(null, "Voulez-vous supprimer ce métro ?", "Suppression", JOptionPane.YES_NO_OPTION); 
	...
	public void remplirPanelLister(String mot) {
		...
		String entetes [] = {"ID Métro", "Matricule", "Marque", "NbKm", "Energie", "Ancienneté"};
